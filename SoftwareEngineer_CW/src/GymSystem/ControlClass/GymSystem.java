...
public class GymSystem {
     ...
     * @version 1.0
     */
    public void addAccountInfo(String accountNum, String password, String username, String phoneNum, String sexual) throws IOException {
        String fileName = "src\\GymSystem\\Information\\accounts.txt";
        FileWriter fileWriter = new FileWriter(fileName, true);
        BufferedWriter bufferedWriter = new BufferedWriter(fileWriter);
        String accountInfo = accountNum + '/' + password + '/' + username + '/' + phoneNum + '/' + sexual;
     ...
     * @version 1.0
     */
    public boolean logIn(String accountNumInput, String passwordInput) throws IOException {
